...
class AggregatorAgent(BaseAggregatorAgent):
    ...
    def __init__(
        ...
        self.llm = llm or AgentConfig.aggregator_llm()

        self._fallback_llm = fallback_llm or AgentConfig.aggregator_fallback_llm()

        self.plan_prompt = plan_prompt or aggregator_plan_prompt()

        self.replan_prompt = replan_prompt or aggregator_replan_prompt()

        self.final_prompt = final_prompt or aggregator_final_prompt()
